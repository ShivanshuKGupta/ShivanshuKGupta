...
\begin{rSection}{Dart/Flutter Packages}
    \begin{itemize}
        \itemsep -3pt {}
        % \item \textbf{\href{https://pub.dev/packages/trans_flutter}{Trans\_Flutter}}: A package to auto-translate all strings in your Flutter codebase at compile time using the \textbf{\href{https://pub.dev/packages/fluttertrans}{CLI}} and provides an easy way to internationalize your app.
